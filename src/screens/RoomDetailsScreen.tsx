...
const RoomDetailsScreen = () => {
  ...
  const { loading, room, error } = useSelector(
    (state: RootStateOrAny) => state.roomDetails
  );
  ...
  const { bookedDates } = useSelector(
    (state: RootStateOrAny) => state.bookedDates
  );
          ...
          <Col>
            ...
            <Row>
              <Col xs={12} sm={12} md={8}>
                ...
                {successCreateReview && (
                  <Message variant="success">Added Review</Message>
                )}
              ...
              <Col xs={12} sm={12} md={4}>
                <Card className="shadow p-3 mb-5 bg-body rounded">
                  <Card.Body>
                    ...
                    {successRoomIsAvailable && (
                      <Message variant="success">Room Is Available</Message>
                    )}
                    {errorRoomIsAvailable && (
                      <Message variant="danger">{errorRoomIsAvailable}</Message>
                    )}
                    ...
                    {loggedIn &&
                      ...
                      !successBookingCreate && (
                        <PayPalButton
                          amount={
                            Number(room.pricePerNight) * Number(daysOfStay)
                          }
                    ...
                    {errorBookingCreate && (
                      <Message variant="success">{errorBookingCreate}</Message>
                    )}
                  </Card.Body>
                </Card>
              </Col>
